...
export default class getStartedPage extends basePage {
  constructor() {
    super(
      "https://rscwealth.com/?inv=c5f669dd0e1659a6723d294b60c15b62f9756133&eid=eWV0YW5vdGhlcmFwZUBnbWFpbC5jb20"
    );
  ...
  getStartedBtn() {
    return browser.$(
      '//header//span[@class="Button-Text" and text() ="Get started"]'
    );
  }
